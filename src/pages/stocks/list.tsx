...
export const StockList = () => {
    ...
    const onPreviousVariant = () => {
        if (currentPageVariant > 1) setCurrentPageVariant(currentPageVariant - 1);
    };

    const onNextVariant = () => {
        if (currentPageVariant < pageCountVariant)
    ...
    const handleUpdateStock = async (variantId: string | number, newQuantity: number) => {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                ...
                <div className="p-4 border border-white bg-transparent rounded-md">
                    <div className="text-sm text-gray-500">
                        Articles à stock faible (≤ {LOW_STOCK_THRESHOLD})
                    </div>
